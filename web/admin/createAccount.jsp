                ...
                <div class="row">
                 ...
                 <div class="mt-3 col-6">
                    ...
                    <input autofocus type="text" name="username" class="w-100 p-2 border-0"
                           style="background-color: #f2f2f2; border-radius: 2px;">
                    <span id="passwordHint" class="hint-msg" style="font-size: 8px;">(Must be no special chars)</span>
                 </div>
                 <div class="mt-3 col-6">
                    <label for="" class="label_option fs-5 fw-blod">Password</label>
                    <input autofocus type="text" name="password" class="w-100 p-2 border-0"
                           style="background-color: #f2f2f2; border-radius: 2px;">
                    <span id="passwordHint" class="hint-msg" style="font-size: 8px;">(Must have 8 chars, 1 num, 1uppercase, 1 special)</span>
                 </div>
                 <div class="mt-3 col-6">
                    <div class="">
